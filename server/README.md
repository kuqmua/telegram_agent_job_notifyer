...
- `CODEX_SANDBOX_WORKSPACE_ROOT` (optional, default `/tmp/telegram_agent_codex_sandbox`)
- `CODEX_SANDBOX_LAUNCHER_PATH` (optional, path to sandbox launcher such as `bwrap`/`firejail`)
